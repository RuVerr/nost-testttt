export default class IntroCarousel {
  ...
  handleAnimationEnd(e) {
    if (e.animationName === "carouselNext") {
      ...
      this.carouselBox.appendChild(this.carouselBox.firstElementChild.firstElementChild);
      this.carouselBox.prepend(this.carouselBox.lastElementChild.lastElementChild);
    }
